                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    ...
                    <ScrollReveal direction="right" delay={0.3}>
                        <div className="lg:col-span-4">
                            <SpotlightCard spotlightColor="rgba(0, 119, 181, 0.2)">
                                <TiltCard className="h-full bento-card rounded-3xl p-8 flex flex-col items-center justify-center text-center">
                                    <motion.div 
